...
grep "externalLink\|doesn't exist." target/site/linkcheck.html | cat
echo "------------ grep of linkcheck.html--END"
RESULT=$(grep "externalLink\|doesn't exist." target/site/linkcheck.html | grep -v 'Read timed out' | wc -l)
